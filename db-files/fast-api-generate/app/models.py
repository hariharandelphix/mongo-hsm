...
class ConnectorResponse(BaseModel):
    id: Optional[int] = Field(None, description="The Connector object entity ID.")
    ...
    connection_properties: Optional[str] = Field(
        None, description="The optional additional properties of this connector."
    )
...
class DataSet(BaseModel):
    ...
    connector_id: int = Field(..., description="ID of the registered Connector model.")
...
class DataSetMapping(BaseModel):
    ...
    data_set_id: int = Field(..., description="ID of the registered Data Set model.")
...
class ObjectDetail(BaseModel):
    ...
    processed: Optional[int] = Field(
        None, description="Processed components of all Post Load Task Components."
    )
...
class PostLoadResponse(BaseModel):
    id: Optional[int] = None
    execution_id: Optional[int] = Field(None, description="Post Load Response model.")
    status: Status1 = Field(..., description="The status of the post load process.")
